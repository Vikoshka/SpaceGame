...
FQuat ULFEulerQuaternion::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void ULFEulerQuaternion::SetWorldRotationQuaternion(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void ULFEulerQuaternion::SetRelativeRotationQuaternion(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void ULFEulerQuaternion::AddLocalRotationQuaternion(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void ULFEulerQuaternion::SetActorWorldRotationQuaternion(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void ULFEulerQuaternion::SetActorRelativeRotationQuaternion(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void ULFEulerQuaternion::AddActorLocalRotationQuaternion(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
